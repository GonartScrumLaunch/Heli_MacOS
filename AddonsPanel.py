...
class Addons:
    ...
    def add(self, widget):
        if self.count < 10:
            y = 165 + self.count * 33
            lcalc = tk.Label(widget, text="Num Of Addons " + str(self.count+1), fg="#eee", bg="#000000", font=("Arial", "10"))
            ...
            lcalc = tk.Label(widget, text="Price Of Addons", fg="#eee", bg="#000000", font=("Arial", "10"))
